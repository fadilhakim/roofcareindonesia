			...
			<div class="container">
				<div class="col-12 col-md-12">
					<div class="d-flex bd-highlight mb-2">
						<div class="title-page">Commercials</div>
					</div>
					<nav aria-label="breadcrumb">
					  <ol class="breadcrumb ">
					    <li class="breadcrumb-item"><a href="index.html">Projects</a></li>
					    <li class="breadcrumb-item active" aria-current="page">Commercials</li>
					  </ol>
					</nav>
				</div>
			</div>
					...
					<div class="col-sm-12 col-md-12 col-lg-4">
						<div class="feature-box-7 shadow">
							...
							<div class="body">
								<div class="info-box">
									<div class="text">
										<div class="title">Commercials-1</div>
					...
					<div class="col-sm-12 col-md-12 col-lg-4">
						<div class="feature-box-7 shadow">
							...
							<div class="body">
								<div class="info-box">
									<div class="text">
										<div class="title">Commercials-2</div>
										<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry orem Ipsum has been. </p>
										<a href="services-detail.html" title="Get Detail">Get Detail</a>
									</div>
								</div>
					...
					<div class="col-sm-12 col-md-12 col-lg-4">
						<div class="feature-box-7 shadow">
							...
							<div class="body">
								<div class="info-box">
									<div class="text">
										<div class="title">Commercials-3</div>
										<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry orem Ipsum has been. </p>
										<a href="services-detail.html" title="Get Detail">Get Detail</a>
									</div>
								</div>
					...
					<div class="col-sm-12 col-md-12 col-lg-4">
						<div class="feature-box-7 shadow">
							...
							<div class="body">
								<div class="info-box">
									<div class="text">
										<div class="title">Commercials-4</div>
										<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry orem Ipsum has been. </p>
										<a href="services-detail.html" title="Get Detail">Get Detail</a>
									</div>
								</div>
					...
					<div class="col-sm-12 col-md-12 col-lg-4">
						<div class="feature-box-7 shadow">
							...
							<div class="body">
								<div class="info-box">
									<div class="text">
										<div class="title">Commercials-5</div>
										<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry orem Ipsum has been. </p>
										<a href="services-detail.html" title="Get Detail">Get Detail</a>
									</div>
								</div>
					...
					<div class="col-sm-12 col-md-12 col-lg-4">
						<div class="feature-box-7 shadow">
							...
							<div class="body">
								<div class="info-box">
									<div class="text">
										<div class="title">Commercials-6</div>
										<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry orem Ipsum has been. </p>
										<a href="services-detail.html" title="Get Detail">Get Detail</a>
									</div>
								</div>
