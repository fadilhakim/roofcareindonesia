  ...
  <div id="home" class="banner">
    	<div class="owl-carousel owl-theme full-screen">
    		<!-- Item 1 -->
	    	<div class="item">
	        	<img src="<?= base_url();?>/public/images/home/home01.jpg" alt="Slider">
	        	<div class="container d-flex align-items-center h-right">
	            	<div class="wrap-caption">
		                <h1 class="caption-heading text-white">ROOFCARE<span><br>INDONESIA</span></h1>
	    	...
	    	<!-- Item 2 -->
	    	<div class="item">
	            <img src="<?= base_url();?>/public/images/home/home02.jpg" alt="Slider">
	            <div class="container d-flex align-items-center h-center">
	            	<div class="wrap-caption">
		               <h1 class="caption-heading text-white"><span>ROOFCARE INDONESIA</span></h1>
		                <p class="uk18 text-white">Our professional team works to increase productivity and cost effectiveness on the market</p>
		                <a href="#" class="btn btn-primary text-white">Get Started</a>
		                <a href="#" class="btn btn-secondary">Learn More</a>
		            </div>
	...
	<!-- CTA -->
	<div class="section bgi-cover-center bg-overlay-primary" data-background="<?= base_url();?>/public/images/home/home03.jpg">
		<div class="content-wrap">
			<div class="container">
				...
				<div class="row mt-5">
					...
					<div class="col-sm-12 col-md-12 col-lg-4">
						<div class="feature-box-7 shadow">
							<div class="media-box">
								<a href="services-detail.html"><img src="<?= base_url();?>/public/images/home/systems.png" alt="" class="img-fluid"></a>
							</div>
							<div class="body">
								<div class="info-box">
									<div class="text">
                  ...
                  <img src="<?= base_url();?>/public/images/home/systems.png" alt="" class="img-fluid">
                </a>
							</div>
							<div class="body">
								<div class="info-box">
	...
	<!-- FACT -->
	<div class="section bgi-cover-center bg-overlay-primary" data-background="<?= base_url();?>/public/images/home/home04.jpg">
		<div class="content-wrap">
			<div class="container">
	...
	<div class="section">
		<div class="content-wrap pb-0">
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-12 col-md-12">
						<h2 class="section-heading text-primary mb-5">
							RECENT NEWS
						</h2>
						<p class="subheading">We provide high standar clean website for your business solutions</p>
					</div>
