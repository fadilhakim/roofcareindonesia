    ...
    <div class="row">
      ...
      <div class="col-sm-12 col-md-8">
        <div class="single-page">
          <img src="<?= base_url() ?>public/images/uploads/<?= $image ?>" alt="" class="img-fluid">
      ...
      <div class="col-sm-12 col-md-4">
        ...
        <div class="widget download">
          <a href="#" class="btn btn-secondary btn-block btn-sidebar"><span class="fa  fa-file-pdf-o"></span>Brochure</a>
        </div>
