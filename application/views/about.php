<!-- BANNER -->
<div class="section banner-page" data-background="<?= base_url();?>/public/images/dummy/about.jpeg">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-12 col-md-4">
        <img style="margin-top:30%;" src="<?= base_url() ?>/public/images/logo_roofcareIndonesia.png" class="img-fluid" alt="">
      </div>
      ...
      <div class="col-12 col-md-7 offset-md-1">
        ...
        <blockquote class="quote">
          ...
          <footer class="blockquote-footer">Budi Khairudin <cite title="Source Title">Head Of Operations</cite></footer>
        </blockquote>
...
<!-- VIDEO -->
<div class="section bgi-cover-center bg-overlay-primary" data-background="<?= base_url() ?>public/images/dummy/banner1.jpg">
<div class="content-wrap">
  <div class="container">
    ...
    <div class="row mt-5">
      ...
      <div class="col-sm-12 col-md-12 col-lg-4">
        <div class="box-image-4">
          <div class="media-img">
            <a href="#"><img src="<?= base_url();?>/public/images/dummy/dummy-img-600x500.jpg" alt="" class="img-fluid"></a>
          </div>
