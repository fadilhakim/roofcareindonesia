    ...
    <div class="container-fluid">
      <div class="block-header">
          <ol class="breadcrumb">
              ...
              <li class="active">Crate Seminars</li>
          </ol>
      </div>
      <div class="row clearfix">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="card">
                  <div class="header">
                      <h2>
                          Nama seminars disini
                      </h2>
                  </div>
                  <div class="body">
                      <form id="form_validation"  enctype="multipart/form-data" method="post" action="<?= base_url() ?>dashboard/seminars/submit">
                            <label class="form-label">Judul Seminar :</label>
                          <div class="form-group">
                              <div class="form-line">
                                  <input type="text" class="form-control" name="judul_seminar" required="" aria-required="true">
                              </div>
