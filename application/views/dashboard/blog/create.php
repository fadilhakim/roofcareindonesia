      ...
      <div class="row clearfix">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="card">
                  ...
                  <div class="body">
                      <form id="form_validation"  enctype="multipart/form-data" method="post" action="<?= base_url() ?>dashboard/blog/submit">
                            <label class="form-label">Judul Blog :</label>
                          <div class="form-group">
                              <div class="form-line">
                                  <input type="text" class="form-control" name="judul_blog" required="" aria-required="true">
                              </div>
                          ...
                          <div class="form-group form-float">
                              <div class="form-line error">
                                  <textarea id="ckeditor" name="deskripsi_blog"></textarea>
                              </div>
