<div class="section banner-page" data-background="<?= base_url() ?>public/images/img_sample/stp.jpg">
		<div class="content-wrap pos-relative">
			<div class="container">
				<div class="col-12 col-md-12">
					<div class="d-flex bd-highlight mb-2">
						<div class="title-page">Steep Slope Roofing</div>
					</div>
					<nav aria-label="breadcrumb">
					  <ol class="breadcrumb ">
					    <li class="breadcrumb-item"><a href="<?= base_url() ?>">Home</a></li>
              <li class="breadcrumb-item">Products</li>
              <li class="breadcrumb-item active" aria-current="page">Steep Slope Roofing</li>
					  </ol>
					</nav>
				</div>
			</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-12 col-sm-12 col-md-4 order-last">
						...
						<!-- <div class="widget categories">
							<ul class="category-nav">
								<li class="active"><a href="#">Re-Roofing-1</a></li>
								<li><a href="#">Re-Roofing-2</a></li>
								<li><a href="#">Re-Roofing-3</a></li>
								<li><a href="#">Re-Roofing-4</a></li>
								<li><a href="#">Re-Roofing-5</a></li>
								<li><a href="#">Re-Roofing-6</a></li>
							</ul>
						</div> -->
					...
					<div class="col-12 col-sm-12 col-md-8">
						<img src="<?= base_url() ?>public/images/img_sample/stepslope.jpg" alt="" class="img-fluid">
						...
						<div class="accordion rs-accordion" id="accordionExample">
						   ...
						   <div class="card">
						      ...
						      <div i  d="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
						         <div class="card-body">
